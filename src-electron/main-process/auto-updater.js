...
async function showUpdateDialog(mainWindow) {
  ...
  const options = {
    ...
    title: "Antd Electron Wallet update available",
    message: "There is a new version of Antd Electron Wallet available.",
...
async function showCannotUpdateDialog(mainWindow) {
  const options = {
    ...
    title: "Cannot update",
    message:
      "Antd Electron Wallet failed to update but there is a new version available. Please go to https://antdaza.site/ and install the new version manually."
  };
